...
@NamedQueries({
		...
		@NamedQuery(name = "Item.findByAddressId", query = "SELECT i FROM Item i WHERE i.addressId = :addressId") })
public class Item implements Serializable {
	...
	public Item(Integer id, int productId, String name, String description,
